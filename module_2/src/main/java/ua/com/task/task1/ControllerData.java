...
public class ControllerData {
    ...
    private static final String file = "D:\\myProjectFile\\nix_7\\module_2\\files\\dates.txt";
            ...
            switch (index) {
                case "1":
                    ...
                    try {
                        ...
                        String[] formattedDates = convertData.formatDate(dateWithDelimiters);
